...
const DATA24 = require('./Distribution statistics for 24.04.2018')
var log_file = fs.createWriteStream(__dirname + '/result24.json', { flags: 'w' });
let result=[];
//console.log(delegationData );
//first we loop through the array of 2018 and
for (let i = 0; i < DATA24.length; i++) {
    const element = DATA24[i];
