 ...
 */
var fs = require('fs');
var arraySource = require('./control-data.json')
var arraySource2 = require('./leaflet-data.json')

var log_file = fs.createWriteStream(__dirname + '/the_closest_points_to_control.json', { flags: 'w' });
     ...
     for (let j = 0; j < arraySource2.length-1; j++) {// this is the data of the leaflet not the controll one
        ...
        //if (j != i) {
            ...
            if (distanceBtweenPoints < closestPoint) {
                ...
                data.idLeaflet=element2.id;
                data.idControl=element.id;
