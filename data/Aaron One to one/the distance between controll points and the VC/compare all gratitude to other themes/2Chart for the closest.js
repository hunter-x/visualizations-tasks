 ...
 */
var fs = require('fs');
var arraySource = require('./res_1_the_closest_points_to_AllSaufGratt_from_GratPoints.json')

var log_file = fs.createWriteStream(__dirname + '/number of distance vc minus 1km closest_points_to_AllSaufTBD_from_alltbd.json', { flags: 'w' });
